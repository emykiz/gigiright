  ...
  <AuthComponentProvider>
    <div class="px-4 py-8 overflow-y-auto">
      <div class="flex flex-col gap-4">
        <p class="font-bold text-4xl">Please Input your preferred languages</p>
      ...
      <form class="flex flex-col justify-evenly h-80 mt-8">
        <div class="flex flex-col gap-8">
          ...
          >
            <input
              type="text"
              placeholder="Input your preferred languages"
              class="w-full p-1"
              name=""
            />
          </div>
        ...
        <div class="mt-auto">
          <SubmitButton msg="Next" background="#0f0" color="#eee" />
        </div>
      </form>
    </div>
  </AuthComponentProvider>
